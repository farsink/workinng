    ...
    <nav class="bg-base-200/90 backdrop-blur-xl rounded-3xl p-1.5 shadow-2xl border border-base-content/5">
      <div class="grid grid-cols-5 items-center gap-1">
        ...
        <NuxtLink 
          ...
          :class="($route.path === '/' || $route.path === '/index') ? 'text-primary' : 'text-base-content/40 hover:text-base-content'"
        >
        ...
        <NuxtLink 
          to="/history"
          class="flex flex-col items-center justify-center gap-1 py-3 px-1 transition-all rounded-2xl hover:bg-base-content/5 group"
          :class="$route.path === '/history' ? 'text-primary' : 'text-base-content/40 hover:text-base-content'"
        >
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <NuxtLink 
          to="/stats"
          class="flex flex-col items-center justify-center gap-1 py-3 px-1 transition-all rounded-2xl hover:bg-base-content/5 group"
          :class="$route.path === '/stats' ? 'text-primary' : 'text-base-content/40 hover:text-base-content'"
        >
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <NuxtLink 
          to="/settings"
          class="flex flex-col items-center justify-center gap-1 py-3 px-1 transition-all rounded-2xl hover:bg-base-content/5 group"
          :class="$route.path === '/settings' ? 'text-primary' : 'text-base-content/40 hover:text-base-content'"
        >
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
// No extra imports needed, Nuxt automatically imports components
defineEmits<{
  (e: 'add'): void
}>()
</script>
